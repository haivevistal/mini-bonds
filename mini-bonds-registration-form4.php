                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="tab-content">
                            <div id="retail-investor" class="tab-pane fade in active">
                                ...
                                <p>
                                <input type="checkbox" id="accept_investment" data-parsley-required="true" data-parsley-error-message="Please accept." data-parsley-errors-container="#accept_investment" data-parsley-multiple="accept_investment" /> I accept that the investments to which the promotions will relate may expose me to a significant risk of losing all of the money or other property invested. I am aware that it is open to me to seek advice from an authorized person who specialists in advising on unlisted shares and unlisted debt securities.
                                </p>
                                <h3>QUESTIONNAIRE</h3>
                                ...
                                <p><input type="checkbox" name="how_easily_sell_bonds" data-parsley-required="true" data-parsley-error-message="Please select." /> The bonds are not freely transferable so I can only sell them under exceptional circumtances</p>
                                <p><input type="checkbox" name="how_easily_sell_bonds" data-parsley-required="true" data-parsley-error-message="Please select." /> Very easily: I can sell them like I do other stocks and bonds</p>
                                
                                <p>&nbsp;</p>
                                <p><strong>2. The expected return from Providence Bonds?</strong></p>
                                <p><input type="checkbox" name="return_providence_bond" data-parsley-required="true" data-parsley-error-message="Please select." /> Is the 7.5% per annum interest paid over the term (plus my money back at the end)</p>
                                <p><input type="checkbox" name="return_providence_bond" data-parsley-required="true" data-parsley-error-message="Please select." /> Is dependent on movements in the financial bond and equity markets</p>
                                
                                <p>&nbsp;</p>
                                <p><strong>3. Is your capital secure?</strong></p>
                                <p><input type="checkbox" name="capital_secure" data-parsley-required="true" data-parsley-error-message="Please select." /> No: My capital is at risk and I Might not get back all that invested</p>
                                <p><input type="checkbox" name="capital_secure" data-parsley-required="true" data-parsley-error-message="Please select." /> Yes: It is guranteed by the Financial Services Compensation Scheme</p>
                                
                                <p>&nbsp;</p>
                                <p><strong>4. Is investment in Providence Bonds intended to be a short, medium or long-term investment?</strong></p>
                                <p><input type="checkbox" name="short_or_long_term" data-parsley-required="true" data-parsley-error-message="Please select." /> It is intended to be held for a fixed number of years</p>
                                <p><input type="checkbox" name="short_or_long_term" data-parsley-required="true" data-parsley-error-message="Please select." /> It is a short-term investment aimed at providing an immediate return</p>
                            </div>
                            <div id="advaised-investor" class="tab-pane fade">
                                ...
                                <p>&nbsp;</p>
                                <p><input type="checkbox" name="advised_investor" data-parsley-required="true" data-parsley-error-message="Please check." /> I am a client of a regulated firm that advises on unlisted shares and unlisted debt securities, which has assessed me as suitable to receive financial promotions and from whom I will seek advice on any investmentI make through IPM. I accept that the investmnet to which the IPM promotions relate my expose me to a significant risk of losing all of the money or other property invested.</p>
                            </div>
                            <div id="self-certified-investor" class="tab-pane fade">
                                ...
                                <p><input type="checkbox" name="self_certified_investor" data-parsley-required="true" data-parsley-error-message="Please check." /> I am aware that it is open to me seek advice from someone who specialises in advising on non-mainstream pooled investments.</p>
                            </div>
                            <div id="high-net-investor" class="tab-pane fade">
                                ...
                                <p><input type="checkbox" name="accept_high_net_investor_promotions" data-parsley-required="true" data-parsley-error-message="Please accpet." /> I accept that the investments to which the promotions will relate may expose me to a significant risk of losing all of the money or other property invested. I am aware that it is open to me to seek advice from an authorized person who specialises in advising on non-mainstream pooled investments.</p>
                                ...
                                <p>&nbsp;</p>
                                <p><strong>1. After you invest in this offer how easily can you sell your bonds?</strong></p>
                                <p><input type="checkbox" name="high_net_investor_how_easily_sell_bonds" data-parsley-required="true" data-parsley-error-message="Please select." /> The bonds are not freely transferable so I can only sell them under exceptional circumtances</p>
                                <p><input type="checkbox" name="high_net_investor_how_easily_sell_bonds" data-parsley-required="true" data-parsley-error-message="Please select." /> Very easily: I can sell them like I do other stocks and bonds</p>
                                
                                <p>&nbsp;</p>
                                <p><strong>2. The expected return from Providence Bonds?</strong></p>
                                <p><input type="checkbox" name="high_net_investor_return_providence_bond" data-parsley-required="true" data-parsley-error-message="Please select." /> Is the 7.5% per annum interest paid over the term (plus my money back at the end)</p>
                                <p><input type="checkbox" name="high_net_investor_return_providence_bond" data-parsley-required="true" data-parsley-error-message="Please select." /> Is dependent on movements in the financial bond and equity markets</p>
                                
                                <p>&nbsp;</p>
                                <p><strong>3. Is your capital secure?</strong></p>
                                <p><input type="checkbox" name="high_net_investor_capital_secure" data-parsley-required="true" data-parsley-error-message="Please select." /> No: My capital is at risk and I Might not get back all that invested</p>
                                <p><input type="checkbox" name="high_net_investor_capital_secure" data-parsley-required="true" data-parsley-error-message="Please select." /> Yes: It is guranteed by the Financial Services Compensation Scheme</p>
                                
                                <p>&nbsp;</p>
                                <p><strong>4. Is investment in Providence Bonds intended to be a short, medium or long-term investment?</strong></p>
                                <p><input type="checkbox" name="high_net_investor_short_or_long_term" data-parsley-required="true" data-parsley-error-message="Please select." /> It is intended to be held for a fixed number of years</p>
                                <p><input type="checkbox" name="high_net_investor_short_or_long_term" data-parsley-required="true" data-parsley-error-message="Please select." /> It is a short-term investment aimed at providing an immediate return</p>
                            </div>
                        </div>
                    </div>
